...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>project_phoenix — Canadian Charter Analysis</p>
...
"""
        ...
        if bad_faith:
            ...
            html += f"""
            <div class="section">
                <h2>⚠️ Bad Faith Policing Analysis</h2>
                <div class="alert {css}">
...
"""
            ...
            html += f"<p><strong>Policing Legislation Sources:</strong> {'; '.join(bad_faith.get('policing_sources', []))}</p>"
            html += "            </div>\n"
        ...
        if crown_conduct:
            ...
            html += f"""
            <div class="section">
                <h2>⚖️ Crown Conduct Analysis</h2>
                <div class="alert {css}">
...
"""
    ...
    def generate_text_report(self, analysis_results, document_metadata, output_path):
        ...
        lines = ["=" * 80, "PROJECT PHOENIX — ANALYSIS REPORT",
                 "project_phoenix — Charter Analysis",
